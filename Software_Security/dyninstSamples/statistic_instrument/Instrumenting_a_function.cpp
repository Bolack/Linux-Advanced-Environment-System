...
std::vector<BPatch_point *> *findPoint(BPatch_addressSpace *app, const char *name,
...
bool createAndInsertSnippet(BPatch_addressSpace *app, std::vector<BPatch_point *> *points)
{
    ...
    BPatch_variableExpr *intCounter = app->malloc(*(appImage->findType("int")), "myCounter");
    ...
    return true; // Create and insert a printf snippet
}
